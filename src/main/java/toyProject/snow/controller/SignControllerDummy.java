...
public class SignControllerDummy {
    ...
    public ResponseEntity<LoginResponse> dummylogin(@ModelAttribute LoginRequest loginRequest){
    ...
    public String dummylogout(@ModelAttribute LoginRequest loginRequest){
        // 이 메서드는 Swagger에만 표시되며, 실제 로직은 필터에서 처리됩니다.
